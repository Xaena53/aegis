...
[![Tests](https://img.shields.io/badge/tests-661-brightgreen.svg)](test/)
...
| **Status** | Working software. Five of six CAMARA links verified against Nokia's live platform; 661 automated tests at 94.27% line coverage; Docker deployment |
...
```
661 tests · 0 failures        line 94.27%  ·  branch 88.86%  ·  function 92.80%
```
