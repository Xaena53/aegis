...
| **Status** | Working software. Five of six CAMARA links verified against Nokia's live platform; 662 automated tests at 94.27% line coverage; Docker deployment |
...
```
662 tests · 0 failures        line 94.27%  ·  branch 88.86%  ·  function 92.80%
```
