...
[![Tests](https://img.shields.io/badge/tests-959-brightgreen.svg)](test/)
...
| **Status** | Working software. All three integrations verified live — Google Ads, five of six CAMARA links, and Meta; 959 automated tests at 89.95% line coverage; Docker deployment |
...
```
959 tests · 0 failures        line 89.95%  ·  branch 90.43%  ·  function 89.76%
```
